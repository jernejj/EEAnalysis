...
public class ExperimentECJ_compareNdimm {
...
//	public static String problem_4 = function + "BFA" + "EEStat" + "_c";
	...
	public static void main(String[] args) 
	{
		...
		double epsSphere = 0.1024;
		double epsRosen = 0.15;
		double epsRas = 0.1024;
		double epsSchw = 10;
		...
		int x[] = new int[4];
		int N = 5;
//		x[0] = N; //X dimension-s is/are changed by epsilon
//		x[1] = N; //X dimension-s is/are changed by epsilon
//		x[2] = N; //X dimension-s is/are changed by epsilon
//		x[3] = N; //X dimension-s is/are changed by epsilon
		Arrays.fill(x, N);
